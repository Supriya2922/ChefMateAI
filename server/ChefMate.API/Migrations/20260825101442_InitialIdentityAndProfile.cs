    ...
    public partial class InitialIdentityAndProfile : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    DietaryPreference = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    CookingSkill = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserProfiles_HouseholdSize", "\"HouseholdSize\" >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCuisines", x => new { x.UserId, x.CuisineId });
                    table.ForeignKey(
                        name: "FK_UserCuisines_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
